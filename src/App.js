...
class App extends React.Component{
    ...
    isOver = () => {
      this.setState({username:'', match_started: false, match_created: false, color:'', stats:null});
    }
          ...
          <div className={`App ${aName}`}>
              <div className="auth-wrapper">
                <div className={`auth-inner ${iName}`}>
                  {this.state.stats && <Leaderboard stats={this.state.stats} onOver={this.isOver}/>}
                  {(!isLoggedIn && !this.state.match_created && !this.state.stats) && <Login
                  ...
                  {(!isLoggedIn && this.state.match_created && !this.state.stats) && <div>
                    Mec kreiran na ${this.state.id}. Cekam protivnika</div>}
                  {(isLoggedIn && !this.state.stats) && <Game  
